...
import { BaseRoute, RouteType, SmartRouterTrade, StablePool, V3Pool } from '../types'
...
/**
 * Represents the  Volrex.Network  V2 + V3 + StableSwap SwapRouter02, and has static methods for helping execute trades.
 */
