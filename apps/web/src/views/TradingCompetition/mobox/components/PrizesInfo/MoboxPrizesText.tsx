...
import { BunnyPlaceholderIcon, Flex, Heading, NftIcon, Text } from '@pancakeswap/uikit'
  ...
  return (
    <StyledFlex flexDirection="column" mb="32px">
      ...
      <Flex>
        ...
        <Text mt="8px">
          {t(
            '300 Mobox Avatars NFT + 300  Volrex.Network  newly designed NFT to the top 100 traders in each of the three teams.',
          )}
        </Text>
      </Flex>
      <Flex>
