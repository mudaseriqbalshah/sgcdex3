  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          This Volrex.Network Affiliate Program Agreement (“<strong>Agreement”</strong>) is a legal contract between you
          (“
        ...
        <Text as="p">
          ...
          used any of Volrex.Network services (including but not limited to V2, V3 swapping services, perpetual trading,
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on Volrex.Network V2 and Volrex.Network V3,
          limited to swap trades on the BNB Smart Chain, Ethereum chain, Polygon zkEVM, zkSync Era, Arbitrum One, Linea,
          and Base chain only; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          7.3 Any statements you make about Volrex.Network must reflect your honest opinions, beliefs, or experiences
          and must not be false, misleading, or unsupported.
        </Text>
        ...
        <Text as="p">You warrant, represent, and undertake to Volrex.Network that:</Text>
        ...
        <Text as="p">
          13.1 Volrex.Network reserves the right to terminate this Agreement in its entirety with or without cause,
          ...
          reason, you shall immediately cease use of (and remove from your site) all links to the Volrex.Network website
        ...
        <Text as="p">
          13.3 Volrex.Network reserves the right to refuse service to anyone for any reason at any time.
        </Text>

        <Text as="h3">14. Indemnification</Text>
        <Text as="p">
          You shall indemnify Volrex.Network from and against all claims, losses, liabilities, damages, administrative
        ...
        <Text as="p">
          (e) directing or causing existing users or previous users of Volrex.Network Services to create new addresses
          to sign up with your referral link
        </Text>
        <Text as="p">
          (f) Conduct marketing or make any representations of any Volrex.Network products and services to users in the
        ...
        <Text as="p">
          Volrex.Network may provide you with trademarks and/or graphical images that can be used to promote
        ...
        <Text as="p">
          ...
          Zambia, Zimbabwe (or any additional country or jurisdiction added to this list by Volrex.Network from time to
