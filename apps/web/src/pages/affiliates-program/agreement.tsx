  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          8.3 Any statements you make about Volrex.Network must reflect your honest opinions, beliefs, or experiences
        ...
        <Text as="p">
          14.1 Volrex.Network reserves the right to terminate this Agreement in its entirety with or without cause,
